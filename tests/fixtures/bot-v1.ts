/* eslint-disable */
/**
 * **旧脑子快照（v1）** —— A/B 基准的对照组，取自重写前的 `shared/sj/bot.ts`（`git show HEAD:`）。
 * 只调了 import 路径，逻辑一字未改；不要在这里修 bug，它存在的意义就是"以前那个机器人"。
 *
...
import type { SjPlayer, SjRoomState } from '../../shared/sj/engine.ts';
